...
insert into TB_Produto(idprod, nomeprod, nomefabrprod, datavalidprod, descricaoprod) values(0, 'NomeProduto0', 'NomeFabricante0', '2021-04-05', 'Descrição do produto 0');
insert into TB_Produto(idprod, nomeprod, nomefabrprod, datavalidprod, descricaoprod) values(1, 'NomeProduto1', 'NomeFabricante1', '2021-05-07', 'Descrição do produto 1');
insert into TB_Produto(idprod, nomeprod, nomefabrprod, datavalidprod, descricaoprod) values(2, 'NomeProduto2', 'NomeFabricante2', '2021-06-10', 'Descrição do produto 2');
